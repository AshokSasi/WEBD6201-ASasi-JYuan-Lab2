...
(function () {
  ...
  function displayHome() {
    ...
    <p style="text-align:center">Author: Mart Virkus, Title: How to Build a Horse with Programming, <a href="https://imgur.com/gallery/60QYd"> Link</a> </p>`;
  ...
  function displayProjects() {
    ...
    projectsText6Element.innerHTML = `<h3>2. Side Scrolling Shooter - Jacky Yuan</h3>
