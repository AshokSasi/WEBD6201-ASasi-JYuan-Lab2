...
(function()
{
    ...
    {
       // navbarProductsElement = document.getElementById("nav-products").innerHTML = '<i class="fas fa-box fa-lg"></i> Projects';
        navbarProductsElement = document.getElementById("nav-products").innerHTML = '<a class="nav-link" aria-current="page" href="projects.html"><i class="fas fa-box fa-lg"></i> Projects</a>';
