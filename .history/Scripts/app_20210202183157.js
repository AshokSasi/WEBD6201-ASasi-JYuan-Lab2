...
function displayHome()
{
    ...
    navbarProductsElement = document.getElementById("nav-products").textContent = `<a id =nav-products class="nav-link" aria-current="page" href="projects.html"><i class="fas fa-box fa-lg"></i> Projects</a>`;
