...
function displayProjects()
{
    ...
    let projectsText2 = "1. Multi-Text Editor - Jacky Yuan";
    let projectsText2Element = document.getElementById("projects-h3-4");
    projectsText2Element.innerHTML =
    `<h1 id="firstHeading">Welcome to WEBD6201 - Lab 1</h1>
    <p id="paragraphOne" class="fs-3 fw-bold">This is my first paragraph</p>`
    let paragraphThree =`<p class="fs-7 fw-bold">And this is the Third Paragraph</p>`;
    mainContent.innerHTML = paragraphThree;
    projectsText2Element.textContent= projectsText2;
}
