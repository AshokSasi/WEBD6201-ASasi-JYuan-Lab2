...
function displayNavbar()
{
    ...
    if (document.title === "HR")
    {
        ...
        navbarProductsElement.innerHTML=`<a class="nav-link active" aria-current="page" href="human-resources.html"><i class="fas fa-brain fa-lg"></i> Human Resources</a>`;
    }
    else
    {
        navbarProductsElement.innerHTML=`<a class="nav-link " aria-current="page" href="human-resources.html"><i class="fas fa-brain fa-lg"></i> Human Resources</a>`;
    }
