...
(function()
{
    function displayNavBar()
    {
       // navbarProductsElement = document.getElementById("nav-products").innerHTML = '<i class="fas fa-box fa-lg"></i> Projects';
        navbarProductsElement = document.getElementById("nav-products").innerHTML = ' class="nav-link" aria-current="page" href="projects.html"><i class="fas fa-box fa-lg"></i> Projects';
