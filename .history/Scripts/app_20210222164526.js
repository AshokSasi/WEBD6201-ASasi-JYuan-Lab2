    ...
    let firstNamePattern = /[A-Z][a-z]{1,30}*/;
      ...
      $("#firstName").on("blur", function()
      {
        if(!firstNamePattern.test($(this).val()))
        {
          ...
          messageArea.show().addClass("alert alert-danger").text("Please enter a valid First Name.The first name must be capitalized and must be between 2-30 characters long.");
        }
        else
        {
