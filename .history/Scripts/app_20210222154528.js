 ...
 function displayLogin()
  ...
  function toggleLogin()
  {
    if (sessionStorage.getItem("user")) 
    {
      ...
      let navUsername = document.createElement("span");

      navUsername.setAttribute("id","nav-username");

      navUsername.className = "navbar-text";
      
      navUsername.textContent= sessionStorage.getItem("user").Username;

      let mainContent = document.getElementById("nav-list");
      mainContent.appendChild(navUsername);

      let logoutLi = document.getElementById("nav-logout");

      navUsername.after(logoutLi);
