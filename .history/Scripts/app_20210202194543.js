...
function displayNavbar()
{
    ...
    //humanResourcesLi.innerHTML= `<a class="nav-link " aria-current="page" href="projects.html">
    //<i class="fas fa-box fa-lg"></i> Human Resources</a>`;

    //humanResourcesLi.before(navbarAboutElement);
}    
