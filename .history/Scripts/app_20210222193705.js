 ...
 * @memberof User
 */
constructor(emailAddress = "",username = "",password ="", firstName="", lastName="") 
    {
    ...
    serialize()
    {
      if(this.EmailAddress !== "" && this.Username !== "" && this.FirstName !== "" && this.LastName !== "")
      {
        return `${this.EmailAddress},${this.Username},${this.FirstName},${this.LastName}`;
      }
      else 
      {
    ...
    deserialize(data)
    {
      ...
      this.EmailAddress = propertyArray[0];
      this.Username = propertyArray[1];
      this.FirstName = propertyArray[2];
      this.LastName = propertyArray[3];
    }
...
((core) => {
  ...
  function testName()
  {
    ...
    let firstNamePattern = /[A-Z][a-z]{1,20}/;
    let lastNamePattern = /[A-Z][a-z]{1,20}/;
  ...
  function displayRegister()
  {
    ...
    errorArea.setAttribute("id","ErrorMessage");
    let registerTitle = document.getElementById("register-title");
   ...
   {
    event.preventDefault();
    let newUser = new core.User(emailAddress.value, username.value, password.value, firstName.value,lastName.value);
 ...
 function displayLogin()
  {
    ...
    $("#loginButton").on("click", function(event){
      ...
      else if(username.val()== "")
      {
        ...
        messageArea.show().addClass("alert alert-danger").text("Error: Username cannot be empty");
      }
      else if(password.val() == "")
      {
        password.trigger("focus").trigger("select");
        messageArea.show().addClass("alert alert-danger").text("Error: Password cannot be empty");
      }
  ...
  function toggleLogin()
  {
    ...
    if (usernameSession) 
    {
      ...
      $(
        `<li><div class="navbar-text">&nbsp;<i class="fas fa-user-circle fa-lg"></i> ${usernameSession} &nbsp;</div></li>`
      ).insertBefore("#nav-login");
